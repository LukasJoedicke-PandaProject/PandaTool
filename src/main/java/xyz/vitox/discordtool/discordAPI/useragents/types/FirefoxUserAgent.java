...
public class FirefoxUserAgent extends UserAgent {
    ...
    public void setBrowserVersions() {
        browserVersions = Arrays.asList("87.0", "86.0", "85.0", "84.0");
    }

    @Override
    public void setBrowserAgents() {
        browserAgents = Arrays.asList(
                "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:87.0) Gecko/20100101 Firefox/" + randomBrowserVersion
        );
    }
