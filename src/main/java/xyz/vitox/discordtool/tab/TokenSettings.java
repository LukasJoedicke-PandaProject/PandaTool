...
import xyz.vitox.discordtool.tab.tokenSettingsComponents.ChangeProfilePicture;
import xyz.vitox.discordtool.tab.tokenSettingsComponents.TokenCleaner;

public class TokenSettings extends StackPane {
    ...
    private VBox leftElements() {
        ...
        leftElements.getChildren().addAll(changeProfilePicture.contentArea());
        return leftElements;
    }
    ...
    private VBox rightElements() {
        ...
        rightElements.getChildren().addAll(tokenCleaner.contentArea());
