...
import xyz.vitox.discordtool.tab.optionComponents.DefaultTokens;
import xyz.vitox.discordtool.tab.optionComponents.LoadProfilePictures;
import xyz.vitox.discordtool.tab.optionComponents.ProxyOptions;
import xyz.vitox.discordtool.tab.optionComponents.UseVerifiedTokens;
...
public class Verifier extends StackPane {
    ...
    private VBox leftElements() {
        ...
        ServerCaptchaVerifiy serverCaptchaVerifiy = new ServerCaptchaVerifiy();
        CommunityVerify communityVerify = new CommunityVerify();

        leftElements.getChildren().addAll(serverCaptchaVerifiy.contentArea(), communityVerify.contentArea());
        return leftElements;
    }
